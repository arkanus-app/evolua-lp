...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "text-slate-900 bg-brand-yellow border-b-4 border-brand-yellowDark hover:brightness-110 active:border-b-0 focus:ring-brand-yellow",
    secondary: "text-primary-900 bg-primary-100 border-b-4 border-primary-300 hover:bg-primary-200 active:border-b-0 focus:ring-primary-200",
    outline: "text-slate-600 bg-white border-2 border-slate-200 border-b-4 hover:bg-slate-50 active:border-b-2 focus:ring-slate-200",
