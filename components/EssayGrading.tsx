...
import { AlertCircle, Bot, CheckCircle, Info, MousePointer2, PenTool } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-32">
            ...
            <p className="text-slate-600 text-lg mb-8 leading-relaxed">{t("essay.subtitle")}</p>
          ...
          <div className="lg:col-span-8 relative">
            <div className="bg-white rounded-[1.5rem] shadow-2xl border border-slate-200 min-h-[600px] relative overflow-hidden flex flex-col md:flex-row">
              ...
              >
                ...
                <h3 className="font-bold text-2xl mb-6 text-black font-sans">
                  {t("essay.doc.title")}
                </h3>

                <p className="mb-6 relative z-10">
                  {t("essay.doc.p1")} {/* Highlight 1: Good (Thesis) */}
                  <span
                ...
                <p className="relative z-10">
                  {t("essay.doc.p3")} {/* Highlight 2: Bad (Vocab) */}
                  <span
                    className="relative inline-block mx-1 cursor-pointer group"
                  ...
                  >
                    ...
                    />
                    <span
                      className={`border-b-2 border-dotted ${focusedId === "vocab" ? "border-red-500" : "border-red-300"}`}
                    >
              ...
              <div className="w-full md:w-80 bg-slate-50 border-l border-slate-200 p-5 flex flex-col gap-4 shadow-[inset_10px_0_20px_-10px_rgba(0,0,0,0.05)]">
                  ...
                  >
                    ...
                    <AnimatePresence>
                      {showInfo && (
                        ...
                        >
                          <div className="font-bold text-brand-yellow mb-2">
                            {t("essay.sidebar.tooltip.title")}
                          </div>
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-bold text-sm text-slate-900">
                      {t("essay.feedback.thesis")}
                    </span>
                  </div>
                  <p className="text-xs text-slate-500 leading-relaxed">
                    {t("essay.feedback.thesis.desc")}
                  </p>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-bold text-sm text-slate-900">
                      {t("essay.feedback.vocab")}
                    </span>
                  </div>
                  <p className="text-xs text-slate-500 leading-relaxed">
                    {t("essay.feedback.vocab.desc")}
                  </p>
                </motion.div>
