...
import { ArrowRight, Building, Check, Lock, Server, Shield, Users } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-slate-600 font-medium">{t("ent.subtitle")}</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">{t("ent.feat1.desc")}</p>
          ...
          >
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">{t("ent.feat2.desc")}</p>
            <div className="flex items-center gap-4 mt-4">
              {/* Logo placeholders for Okta, Google, Azure */}
              <div className="h-10 w-20 bg-slate-100 rounded-lg flex items-center justify-center font-bold text-slate-400 text-xs">
                Okta
              </div>
              <div className="h-10 w-20 bg-slate-100 rounded-lg flex items-center justify-center font-bold text-slate-400 text-xs">
                Azure
          ...
          >
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">{t("ent.feat3.desc")}</p>
            <ul className="space-y-3">
