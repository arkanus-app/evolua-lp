            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-8">
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-brand-yellowDark to-orange-500">
                    {t("hero.title.2")}
                  </span>
                  <svg
                    className="absolute -bottom-2 left-0 w-full h-3 text-brand-yellow opacity-40"
                    viewBox="0 0 100 10"
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button
                  href="/login"
                  className="text-lg px-8 py-4 shadow-xl shadow-brand-yellow/20"
                >
                ...
                <div className="bg-slate-50 px-6 pt-4 pb-0 border-b-2 border-slate-200 flex items-end justify-between gap-8">
                  ...
                  <div className="flex-1 flex gap-2 overflow-x-auto no-scrollbar">
                    {[
                      {
                        id: "overview",
                        label: t("hero.dash.overview"),
                        icon: LayoutDashboard,
                      },
                      {
                        id: "creator",
                        label: t("hero.dash.creator"),
                        icon: Sparkles,
                      },
                      {
                        id: "gradebook",
                        label: t("hero.dash.gradebook"),
                        icon: GraduationCap,
                      },
                    ].map((tab) => (
                      <button
                      ...
                      >
                        <tab.icon
                          className={`w-4 h-4 ${activeTab === tab.id ? "text-brand-yellowDark" : ""}`}
                        />
                        {tab.label}
                        {activeTab === tab.id && (
                    ...
                    {activeTab === "overview" && (
                      ...
                      >
                        <div className="grid grid-cols-3 gap-2 sm:gap-4 shrink-0">
                          {[
                            {
                              label: t("hero.dash.avgScore"),
                              val: "88.4%",
                              sub: "+2.1%",
                              color: "text-green-500",
                            },
                            {
                              label: t("hero.dash.pending"),
                              val: "12",
                              sub: t("hero.dash.requiresReview"),
                              color: "text-orange-500",
                            },
                            {
                              label: t("hero.dash.attendance"),
                              val: "95%",
                              sub: t("hero.dash.stable"),
                            ...
                            >
                              ...
                              <div className={`${stat.color} text-[10px] font-bold`}>
                                {stat.sub}
                              </div>
                            </motion.div>
                          ))}
                              ...
                              <motion.div className="space-y-4">
                                ...
                                >
                                  <div className="flex gap-3 mb-3">
                                    <div className="w-6 h-6 rounded-full bg-brand-yellow flex items-center justify-center text-xs font-bold">
                                      1
                                    </div>
