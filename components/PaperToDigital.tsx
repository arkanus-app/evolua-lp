...
import { BarChart2, CheckCircle2, Download, FileText, PieChart, Zap } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 md:mb-20">
          ...
          <h3 className="text-3xl md:text-5xl font-extrabold text-white mb-6">
            {t("p2d.title.1")} <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-yellow to-orange-400">
              {t("p2d.title.2")}
            </span>
          </h3>
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">{t("p2d.subtitle")}</p>
        </div>
          ...
          <div className="transform scale-[0.4] sm:scale-75 md:scale-90 lg:scale-100 origin-center">
            <div className="relative h-[600px] w-[900px] flex items-center justify-center">
              ...
              <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-[200px] flex flex-col items-center">
                ...
                <div className="mt-8 text-center font-bold text-slate-500 text-sm tracking-widest uppercase">
                  {t("p2d.rawInput")}
                </div>
              </div>
              ...
              <div className="absolute right-0 top-0 bottom-0 w-[300px] flex flex-col justify-between py-10 z-10">
                ...
                <div className="relative">
                  <div className="relative w-full bg-slate-900/90 backdrop-blur-xl rounded-2xl border border-slate-700/50 overflow-hidden shadow-[0_0_40px_-10px_rgba(250,204,21,0.15)] ring-1 ring-white/10 h-[220px]">
                    ...
                    <div className="p-4 space-y-2">
                      {[0, 1, 2].map((i) => (
                        ...
                        >
                          <div className="w-6 h-6 rounded bg-slate-700 flex items-center justify-center text-[8px] text-slate-400 font-bold">
                            #{104 + i}
                          </div>
                  ...
                  <div className="mt-2 text-center font-bold text-slate-500 text-xs tracking-widest uppercase">
                    {t("p2d.structuredData")}
                  </div>
                </div>
                  ...
                  <div className="relative w-full bg-slate-800 rounded-2xl border border-slate-600 shadow-xl p-4 h-[220px] flex flex-col justify-between">
                    ...
                    <AnimatePresence mode="wait">
                      {reportStatus === "generating" ? (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <div className="w-6 h-6 bg-green-500/20 rounded flex items-center justify-center text-[8px] font-bold text-green-400">
                              PDF
                            </div>
                            <span className="text-[9px] font-bold text-green-100">
                              Report_Ready.pdf
                            </span>
                          </div>
